import { IonItem, IonLabel, IonInput, IonHeader, IonPage, IonTitle, IonToolbar, IonCardContent, IonCardHeader, IonButton, IonCard, useIonToast, IonCheckbox } from '@ionic/react';
import { useState } from 'react';
import Tab1FormStyle from './Tab1.module.css';
...
const Tab1: React.FC = () => {
  ...
  return (
    <IonPage className={Tab1FormStyle.formPage}>
      <IonHeader>
        <IonToolbar>
          <IonTitle>Bank transaction</IonTitle>
        </IonToolbar>
      </IonHeader>
      <IonCard className={Tab1FormStyle.formCard}>
        <IonCardHeader className={Tab1FormStyle.formCardHeader}>
        ...
        <IonCardContent>
          ...
          {/* <IonItem>
              <IonLabel position="stacked">Type of execution:</IonLabel>
              <br></br>
            <IonItem>
              <IonItem>
                <IonLabel slot="start">Standard</IonLabel>
                <IonCheckbox value={"standrad"} onIonChange={e => setExecution(e.detail.value!)} />
              </IonItem>
              <IonItem>
                <IonLabel slot="start">Urgent</IonLabel>
                <IonCheckbox value={"urgent"} onIonChange={e => setExecution(e.detail.value!)} />
              </IonItem>
              <IonItem>
                <IonLabel slot="start">Instant Payment</IonLabel>
                <IonCheckbox value={"instant payment"} onIonChange={e => setExecution(e.detail.value!)} />
              </IonItem>
            </IonItem>
          </IonItem> */}
          <IonItem>
